...
*Wallet is now built on top of a fully working Ledger + CFE. The Wallet module is a thin layer handling user-facing concerns: balances, limits, transfer UX, and notifications. All financial logic (holds, posting, fees) delegates to CFE.*
