# فهرس - سحب وكيل (Agent Withdrawal)
...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | سحب وكيل |
| الأولوية | P0 |
| API | POST /api/v1/withdraw/agent |
| Controller | AgentWithdrawController |
| Service | AgentWithdrawService |
| Event | AgentWithdrawalCompleted |
| Listener | SendAgentWithdrawalNotification |
| DB Tables | transactions, wallets, agents |
| رسوم | 0% (مجاني) |
| حد يومي | max 500 USD/day |
| Flutter Screen | AgentWithdrawScreen |
| React Page | AgentWithdrawPage |
