...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | إيداع وكيل |
| الأولوية | P0 |
| API | POST /api/v1/deposit/agent |
| Controller | AgentDepositController |
| Service | AgentDepositService |
| Event | AgentDepositCompleted |
| Listener | SendAgentDepositNotification |
| DB Tables | transactions, wallets, agents |
| رسوم | 0% |
| حد يومي | max 1000 USD/day |
| Flutter Screen | AgentDepositScreen |
| React Page | AgentDepositPage |
