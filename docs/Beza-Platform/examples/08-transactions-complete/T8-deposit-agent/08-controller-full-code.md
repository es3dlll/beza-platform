...
```php
<?php
// app/Http/Controllers/Api/AgentDepositController.php

namespace App\Http\Controllers\Api;

use App\Http\Controllers\Controller;
use App\Http\Requests\AgentDepositRequest;
use App\Http\Resources\TransactionResource;
use App\Services\AgentDepositService;
use Illuminate\Http\JsonResponse;

class AgentDepositController extends Controller
{
    public function __construct(
        private readonly AgentDepositService $service
    ) {}

    public function execute(AgentDepositRequest $request): JsonResponse
    {
        $user = $request->user();
