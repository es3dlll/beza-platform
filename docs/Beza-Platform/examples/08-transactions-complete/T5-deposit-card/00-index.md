# فهرس - إيداع بطاقة ائتمانية (Card Deposit)
...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | إيداع بطاقة ائتمانية |
| الأولوية | P1 |
| API | POST /api/v1/deposit/card |
| Controller | CardDepositController |
| Service | CardDepositService / PaymentGatewayService |
| Event | CardDepositCompleted |
| Listener | SendCardDepositNotification |
| DB Tables | transactions, card_deposits, wallets |
| رسوم | 2.5% |
| حد يومي | 5000 USD/day |
| Flutter Screen | CardDepositScreen |
| React Page | CardDepositPage |
