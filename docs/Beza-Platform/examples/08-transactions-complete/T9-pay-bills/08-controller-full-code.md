...
```php
<?php
// app/Http/Controllers/Api/PayBillsController.php
...
use App\Services\PayBillsService;
use Illuminate\Http\JsonResponse;

class PayBillsController extends Controller
{
    public function __construct(
        private readonly PayBillsService $service
    ) {}

    public function execute(PayBillsRequest $request): JsonResponse
    {
        $user = $request->user();
...
use App\Http\Controllers\Api\PayBillsController;
