# فهرس - AG1: تسجيل وكيل جديد (Register Agent)
...
├── 09-service-layer-core.md        # AgentRegistrationService كامل
├── 10-auth-guards-middleware.md    # المصادقة والصلاحيات
├── 10-service-layer-wallet.md      # WalletService للتكامل
├── 11-events-and-listeners.md      # أحداث: AgentRegistered
...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | تسجيل وكيل جديد |
| الأولوية | P0 (حرجة) |
| API | `POST /api/v1/agent/register` |
| Controller | `AgentRegistrationController@register` |
| Service | `AgentRegistrationService` |
| Event | `AgentRegistered` |
| Listener | `SendAgentApprovalNotification` |
| DB Tables | agent_requests, agents |
| Flutter Screen | `AgentRegisterScreen` |
| React Page | `AgentRegisterPage` |
