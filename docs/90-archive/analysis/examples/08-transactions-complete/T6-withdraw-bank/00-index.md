...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | سحب بنكي |
| الأولوية | P0 |
| API | POST /api/v1/withdraw/bank |
| Controller | BankWithdrawController |
| Service | BankWithdrawService |
| Event | WithdrawInitiated / WithdrawCompleted / WithdrawRejected |
| Listener | SendWithdrawNotification |
| DB Tables | transactions, bank_withdrawals, wallets |
| رسوم | 1% |
| حد يومي | min 5 USD, max 10000 USD/day |
| Flutter Screen | BankWithdrawScreen |
| React Page | BankWithdrawPage |
