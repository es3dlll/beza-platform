...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | طلب المال |
| الأولوية | P2 |
| API | POST /api/v1/transfer/request, POST /api/v1/transfer/request/{id}/accept, POST /api/v1/transfer/request/{id}/reject |
| Controller | RequestMoneyController |
| Service | RequestMoneyService |
| Event | MoneyRequested / MoneyRequestAccepted / MoneyRequestRejected |
| Listener | SendMoneyRequestNotification |
| DB Tables | transactions, money_requests, wallets |
| رسوم | 0% |
| حد يومي | 2000 USD/day |
| Flutter Screen | RequestMoneyScreen + PendingRequestsScreen |
| React Page | RequestMoneyPage + PendingRequestsPage |
