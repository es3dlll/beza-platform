...
```php
<?php
// tests/Feature/BankDepositTest.php
...
class BankDepositTest extends TestCase
{
    ...
    {
        $response = $this->withToken($this->token)->postJson('/deposit/bank', [
            'amount'   => 100.00,
            'currency' => 'USD',
            'pin'      => '1234',
        ]);
    ...
    {
        $response = $this->postJson('/deposit/bank', [
            'amount'   => 100.00,
            'currency' => 'USD',
            'pin'      => '1234',
        ]);
...
```bash
php artisan test --filter=BankDepositTest
