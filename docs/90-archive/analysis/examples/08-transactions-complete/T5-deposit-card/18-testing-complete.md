...
```php
<?php
// tests/Feature/CardDepositTest.php
...
class CardDepositTest extends TestCase
{
    ...
    {
        $response = $this->withToken($this->token)->postJson('/deposit/card', [
            'amount'   => 100.00,
            'currency' => 'USD',
            'pin'      => '1234',
        ]);
    ...
    {
        $response = $this->postJson('/deposit/card', [
            'amount'   => 100.00,
            'currency' => 'USD',
            'pin'      => '1234',
        ]);
...
```bash
php artisan test --filter=CardDepositTest
