...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | دفع الفواتير |
| الأولوية | P2 |
| API | POST /api/v1/bills/pay |
| Controller | BillPaymentController |
| Service | BillPaymentService / BillProviderService |
| Event | BillPaymentCompleted |
| Listener | SendBillPaymentNotification |
| DB Tables | transactions, bill_payments, wallets |
| رسوم | 0% أو حسب مزود الخدمة |
| حد يومي | حسب نوع الفاتورة |
| Flutter Screen | BillPaymentScreen |
| React Page | BillPaymentPage |
