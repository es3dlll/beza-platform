...
├── 10-service-layer-admin.md        # AdminDealService كامل
├── 11-events-and-listeners.md       # DealCreated + مستمعيه
├── 12-notification-system.md        # FCM + إشعارات للمستثمرين
...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | إنشاء صفقة استثمارية (Admin) |
| الأولوية | P1 (عالية) |
| API | `POST /api/v1/admin/deals` |
| Controller | `AdminDealController@store` |
| Service | `DealService` / `AdminDealService` |
| Event | `DealCreated` |
| Listener | `SendDealCreatedNotification` |
| DB Tables | deals, deal_investments, wallets, transactions |
| صلاحية | Admin فقط |
| Flutter Screen | `AdminDealCreateScreen` |
| React Page | `AdminDealCreatePage` |
