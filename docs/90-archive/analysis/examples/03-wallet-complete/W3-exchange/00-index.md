# فهرس - تحويل بين العملات (W3 Exchange)
...
├── 10-service-layer-exchange.md     # ExchangeService كامل
├── 11-events-and-listeners.md       # ExchangeCompleted + مستمعيه
...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | تحويل بين العملات (صرافة) |
| الأولوية | P1 (عالية) |
| API | `POST /api/v1/wallet/exchange` |
| Controller | `ExchangeController@exchange` |
| Service | `ExchangeService` / `WalletService` |
| Event | `ExchangeCompleted` |
| Listener | `SendExchangeNotification` |
| DB Tables | wallets, transactions |
| أقل مبلغ | 1 USD أو 1000 SYP |
| رسوم الصرافة | 1-2% (هامش ربح) |
| سعر الصرف | حسب السوق (config) |
| Flutter Screen | `ExchangeScreen` + `ExchangeForm` |
| React Page | `ExchangePage` |
