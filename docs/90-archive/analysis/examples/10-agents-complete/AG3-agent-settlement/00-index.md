# فهرس - AG3: تسوية العمولات (Agent Settlement)

```
AG3-agent-settlement/
├── 00-index.md                     ← أنت هنا
...
├── 09-service-layer-core.md        # AgentSettlementService كامل
├── 10-service-layer-wallet.md      # WalletService للتكامل
├── 11-events-and-listeners.md      # أحداث: SettlementRequested
...
| العنصر | القيمة |
|--------|--------|
| اسم العملية | تسوية العمولات |
| الأولوية | P1 (مهم) |
| API | `POST /api/v1/agent/settlement` |
| Controller | `AgentSettlementController@settle` |
| Service | `AgentSettlementService` |
| Event | `SettlementRequested` |
| Listener | `SendSettlementNotification` |
| DB Tables | agent_settlements, agent_bank_accounts |
| Flutter Screen | `AgentSettlementScreen` |
| React Page | `AgentSettlementPage` |
