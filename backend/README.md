...
│   │   ├── Float/            # Agent float management
│   │   ├── Settlement/       # Merchant/partner settlement engine
│   │   ├── Notification/     # In-app + push notifications
│   │   ├── Wallet/           # Digital wallet + P2P transfers (via CFE)
...
│   │   ├── Savings/          # Savings goals engine
│   │   ├── GovCollections/   # Government fee collection
...
All endpoints under `api/v1/{module}`. OpenAPI spec at `docs/openapi.yaml` (937 lines, 40+ endpoints).
