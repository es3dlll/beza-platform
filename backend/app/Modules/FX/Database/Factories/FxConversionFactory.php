...
class FxConversionFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'quote_id' => (string) Str::ulid(),
            'base_currency' => 'SYP',
            'quote_currency' => $this->faker->randomElement(['USD', 'EUR']),
            'source_amount' => $this->faker->numberBetween(1000, 10000000),
            ...
            'total_charge' => $this->faker->numberBetween(1100, 10005000),
            'status' => 'completed',
