...
import TransactionSearch from './pages/transactions/TransactionSearch';
import FraudCases from './pages/fraud/FraudCases';
...
const AdminLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/kyc', label: 'توثيق الهوية', icon: '🪪' },
    { path: '/admin/agents', label: 'الوكلاء', icon: '🏪' },
    { path: '/admin/transactions', label: 'العمليات', icon: '💳' },
    { path: '/admin/fraud', label: 'الاحتيال', icon: '🛡️' },
    { path: '/admin/fx-rates', label: 'أسعار الصرف', icon: '💰' },
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="fraud" element={<FraudCases />} />
